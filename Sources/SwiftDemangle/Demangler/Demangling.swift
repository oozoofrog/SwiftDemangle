...
extension Demangling where Self: StringProtocol, Self: Mangling {
    ...
    internal var isMangledName: Bool {
        manglingPrefixLength(from: self) > 0
    }
    
    internal var isObjCSymbol: Bool {
    ...
    internal var droppingSwiftManglingPrefix: String {
    ...
    internal func demangleOldSymbolAsNode() -> Node? {
